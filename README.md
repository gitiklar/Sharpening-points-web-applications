...
<div dir="rtl">
  <h1>מה זה useRef</h1>
    ...
    ולכן בגישה הזו אין לנו את הגישה הישירה לדום.<br>
    יש מצבים מסויימים נדירים שבהם הגישה לדום היא הכרחית כמו פוקוס על אלמנט או API חיצוני כלשהו שדורש אלמנט.
    ...
    ואז לאותו אלמנט שאנו רוצים עבורו את ההפניה, אנחנו נותנים מאפיין מיוחד שנקרא ref והוא יהיה שווה לאותו משתנה שקיבל את הערך שלו מה-useRef
    המאפיין הזה אומר לריאקט כשאתה לוקח את האלמנט הזה ומחבר אותו לדום אלמנט אמיתי - כי הרי כאן מדובר בוירטואל דום אלמנט -
    אז שמור את ההפניה לדום אלמנט האמיתי ותן לי לגשת אליו באמצעות המשתנה שהגדרתי נקודה current וזה ה.<br>
