...
<div dir="rtl">
  <h1>מהו המאפיין key?</h1>
    <p>
       המאפיין key מסמן לריאקט את הקשר בין האלמנט ברנדר הקודם לאותו אלמנו ברנדר הבא.<br>
       כשאנחנו נותנים key  ריאקט יכול להסתכל על תוצאה של רנדר ישן ורנדר חדש ולהתאים אלמנטים ובצורה כזו הוא לא יצטרך ליצור מחדש אלמנטים שכבר נמצאים שם <br>
       ...
       גם אם יש הבדל בתוכן של האלמנטים - ריאקט יתן פקודות לשנות רק את מה שהכרחי.<br>
       דוגמא:<br>
       ...
       ז"א שברנדר הבא יהיה לריאקט ביד גם את הדום אלמנט החדש שנראה כך:<br>
       [A , B , D , E]<br>
       כאשר אין מפתחות , ברירת המחדל של ריאקט הוא האינדקס, כלומר המיקום שלו ברשימה.<br>
       ואז ריאקט מחשב את זה כך:<br>
       הקוביה הראשונה A לא השתנתה, ולכן תקבל את אותם מאפיינים<br>
       הקוביה השניה B גם כן לא השתנתה ולכן תקבל את אותם מאפיינים<br>
       הקוביה השלישית אותו מקום שבו היה האלמנט C כעת יש שם אלמנט אחר שנקרא D ולכן תקבל את המאפיינים של D<br>
       הקוביה השלישית אותו מקום שבו היה האלמנט E כעת יש שם אלמנט אחר שנקרא D ולכן תקבל את המאפיינים של E<br>
