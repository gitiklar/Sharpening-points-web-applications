...
<div dir="rtl">
  <h1>מה זה useEffect</h1>
    <p>
      ...
      יש לנו משהו בסטייט שמתעדכן ואחרי שמתעדכן יש UI חדש שיוצר איזשהו אירוע שמעדכן שוב פעם את הסטייט ואז שוב תבצע רנדר ל-UI חדש ת וזה נראה כך:<br>
      ...
      useEffect הוא הדרך שלנו לקשר בין משתנה סטייט לבין משהו שקורה מחוץ למעגל הזה, התבנית היא כזו: <br>
      useEffect(()=>{<br>
        //run code here if dependencies change<br>
