...
<div dir="rtl">
  <h1>ארכיטקטורת flux</h1>
    <p>
אנחנו יודעים לשמור מידע בתור משתנה State של פקד, וגם להעביר מידע מפקד לילדים שלו, אבל בינינו העסק הזה הופך קשה יותר ויותר ככל שהמרחק בין הפקד העליון ביותר שצריך את המידע לפקד התחתון ביותר שצריך אותו גדל.<br>    
