...
<div dir="rtl">
  <h1>מה זה useRef</h1>
    ...
    ולכן בגישה הזו אין לנו את הגישה הישירה לדום.
    יש מצבים מסויימים נדירים שבהם הגישה לדום היא הכרחית כמו פוקוס על אלמנו או API חיצוני כלשהו שדורש אלמנט 
    עבור המקרים האלה ריאקט נותן לנו את ה-USEREF שהוא בעצם הQUERYSELECTOR של ריאקט זו הדרך להגיע ממש לאלמנט
    איך זה עובד:
    מגדירים איזשהו משתנה שמתקבל מUSEREF
    ואז לאותו אלמנו שאנו רוצים עבורו את ההפניה, אנחנו נותנים מאפיין מיוחד שנקרא REF והוא יהיה שווה לאותו משתנה שקיבל את הערך שלו מה-USEREF
    המאפיין הזה אומר לריאקט כשאתה לוקח את האלמנט הזה ומחבר אותו לדום אלמנט אמיתי כי הרי כאן מדובר בוירטואל דום אלמנט
    אז שמור את הרפרנס לדום אלמנו האמיתי ותן לי לגשת אליו באמצעות המשתנה שהגדרתי נקודה CURRENT וזה ה
