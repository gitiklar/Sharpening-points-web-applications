...
<div dir="rtl">
  <h1>מהו המאפיין key?</h1>
    <p>
       ...
       אם הוא רואה איזשהו מפתח שקיים בשני הוירטואל דום , והמאפיינים שלו לא השתנו, אז הוא יקח את האלמנט בשלימותו ולא ייצור אותו מחדש.<br>
       בצורה כזו אנחנו מבטיחים ביצועים טובים יותר.<br>
       גם אם יש הבדל בתוכן של האלמנטים - ריאקט יתן פקודות לשנות רק את מה שהכרחי.
      </p>
</div>
