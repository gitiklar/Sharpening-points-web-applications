...
<div dir="rtl">
    <p>
הפרמטר הראשון ל useCallback הוא הפונקציה, והפרמטר השני הוא מערך של משתנים שהפונקציה תלויה בהם. עכשיו כל פעם שאחד הדברים במערך ישתנה ריאקט יבנה מחדש את הפונקציה, אבל כל עוד משתנים אלה שומרים על ערכם גם הפונקציה תישאר זהה.    </p>  
</div>
